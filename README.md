...
This repository provides all the tooling to manage the `corp` account infrastructure on AWS. It distributes a single docker container which bundles the entire tool-chain and infrastructure as code necessary to administer the account.

## Acount Details

| Property       | Value                                                                                                                         |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| AWS Account ID | 418769461135                                                                                                             |
| Account Email  | ops+corp@ryanjarv.sh                                                                                                      |
| Login URL      | <https://signin.aws.amazon.com/switchrole?account=418769461135&roleName=OrganizationAccountAccessRole&displayName=rjsh-corp-admin> |
| Namespace      | rjsh                                                                                                                  |
| Stage          | corp                                                                                                                      |
...
Here is the list of some of the tools we use to provision `corp.ryanjarv.sh` infrastructure in order to facilitate cloud fabrication and administration:
...
```bash
/usr/local/bin/corp.ryanjarv.sh
```

**NOTE (a):** You can just run `corp.ryanjarv.sh`, if your `PATH` contains `/usr/local/bin`
